...
')
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\MacroServiceProvider::blueprintMacros()
         * @param bool $nullable
         * @param string $relatedTable
         * @param string $relatedColumn
         * @static 
         */ 
        public static function activitiesBy($nullable = true, $relatedTable = 'users', $relatedColumn = 'id')
        {
                        return \Illuminate\Database\Schema\Blueprint::activitiesBy($nullable, $relatedTable, $relatedColumn);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function dropActivitiesBy()
        {
                        return \Illuminate\Database\Schema\Blueprint::dropActivitiesBy();
        }
